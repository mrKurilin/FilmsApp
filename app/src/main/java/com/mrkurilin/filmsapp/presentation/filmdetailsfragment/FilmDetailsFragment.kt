    ...
    private fun updateUI(uiState: FilmDetailsUIState) {
        when (uiState) {
            ...
            is FilmDetailsUIState.FilmLoaded -> {
                ...
                with(fragmentFilmDetailsBinding) {
                    filmCountries.text = getString(R.string.countries, film.countries)
                    filmYear.text = getString(R.string.year, film.year)
                    filmGenres.text = getString(R.string.genres, film.genres)
